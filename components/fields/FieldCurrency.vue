...
// Backpack-style money input: same numeric model as FieldNumber (a real
// number, '' clears to undefined) but displays thousands-formatted
// ('1,000.00') while blurred and a plain editable number while focused, so
// typing isn't disrupted by commas being inserted mid-edit.
