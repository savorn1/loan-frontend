  ...
  <div class="min-h-screen flex bg-white dark:bg-gray-950">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-600 to-indigo-700 text-white flex-col justify-between p-12">
      ...
      <div class="relative max-w-sm">
        ...
        <p class="text-lg font-medium text-white/90 mb-3">Manage every loan, customer, and payment in one place.</p>
        <p class="text-sm text-white/70">
          Track applications from request to payoff, keep the payment schedule on track, and give your team one shared source of truth.
        </p>
      </div>
